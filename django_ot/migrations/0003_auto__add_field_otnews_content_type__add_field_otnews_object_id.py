...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OtNews.content_type'
        db.add_column(u'django_ot_otnews', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OtNews.object_id'
        db.add_column(u'django_ot_otnews', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OtNews.content_type'
        db.delete_column(u'django_ot_otnews', 'content_type_id')

        # Deleting field 'OtNews.object_id'
        db.delete_column(u'django_ot_otnews', 'object_id')
