...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CmsOtConfig.parent_page'
        db.add_column(u'otcms_cmsotconfig', 'parent_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CmsOtConfig.parent_page'
        db.delete_column(u'otcms_cmsotconfig', 'parent_page_id')
