...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CmsOtConfig.user'
        db.add_column(u'otcms_cmsotconfig', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CmsOtConfig.user'
        db.delete_column(u'otcms_cmsotconfig', 'user_id')
    ...
    models = {
        ...
        u'otcms.cmsotconfig': {
            ...
            'parent_page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']", 'null': 'True', 'blank': 'True'}),
